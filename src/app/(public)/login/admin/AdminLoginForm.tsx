...
import { Trophy, Lock, ShieldAlert, CheckCircle2, User } from 'lucide-react';
      ...
      <div className="w-full max-w-md bg-[#0d0d12] border border-[#21212c] rounded-2xl p-8 space-y-8 shadow-2xl relative overflow-hidden animate-zoom-in">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            <div className="relative flex items-center justify-between bg-[#14141d] border border-[#272737] rounded-xl py-3 px-4 text-sm">
              <div className="flex items-center space-x-2.5 text-zinc-300">
                <User className="h-4 w-4 text-zinc-500" />
                <span className="font-extrabold">admin</span>
              </div>
              <span className="text-[10px] uppercase tracking-wider bg-zinc-800 text-zinc-500 px-2 py-0.5 rounded font-black border border-zinc-700/40">
                Solo lectura
              </span>
            </div>
          </div>
          ...
          >
            {loading ? 'Accediendo...' : 'Entrar como administrador'}
          </button>
        </form>
